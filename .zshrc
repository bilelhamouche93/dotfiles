...
alias fehr='feh -rzF --borderless --scale-down --auto-zoom -g 800x600 --action "dolphin --select '%f'" --action1 "cp '%f' ~/desktop/"'
alias fehr5='feh -rzFD5 --borderless --scale-down --auto-zoom -g 800x600 --action "dolphin --select '%f'" --action1 "cp '%f' ~/desktop/"'
alias fehr10='feh -rzFD10 --borderless --scale-down --auto-zoom -g 800x600 --action "dolphin --select '%f'" --action1 "cp '%f' ~/desktop/"'
